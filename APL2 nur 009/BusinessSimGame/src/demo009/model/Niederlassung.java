...
public class Niederlassung extends Standort {
	...
	public void setAnzahlArbeitende(int aktuelleArbeiter) {
		this.arbeitende = aktuelleArbeiter;
	}
	public int getLohn() {
		return lohn;
	}
	...
	int gesendeteFuhrwerke = 0;
	
	public int getgesendeteFuhrwerke() {
		return gesendeteFuhrwerke; 
	}
	
	public void setgesendetefuhrwerke(int neugesendeteFuhrwerke) {
		this.gesendeteFuhrwerke = gesendeteFuhrwerke + neugesendeteFuhrwerke;
	}
}
